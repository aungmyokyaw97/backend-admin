(function ($, DataTable) {
    ...
    //Courses button
    DataTable.ext.buttons.courses = {
        className: 'buttons-courses',

        text: function (dt) {
            return '<i class="fa fa-newspaper"></i> ' + dt.i18n('buttons.courses', 'All Courses');
        },
    ...
    //Exercise button
    DataTable.ext.buttons.exercises = {
        className: 'buttons-exercises',

        text: function (dt) {
            return '<i class="fa fa-newspaper"></i> ' + dt.i18n('buttons.exercises', 'All Exercises');
        },
    ...
    //Unit button
    DataTable.ext.buttons.units = {
        className: 'buttons-units',

        text: function (dt) {
            return '<i class="fa fa-newspaper"></i> ' + dt.i18n('buttons.units', 'All units');
        },
        ...
        action: function (e, dt, button, config) {
            ...
            var arr = URL.split('/');
            var unit_id = arr[5];
            window.location = '/admin/course-unit/' + unit_id;
        }
    };
