...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="/images/fav_icons/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/images/fav_icons/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/images/fav_icons/favicon-16x16.png">
        ...
        <ul class="navbar-nav ml-auto">
            <li class="nav-item dropdown user-menu">
                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
                    <img src="{!! asset('admin_profile.png') !!}"
...
<script>
    $(document).ready(function () {
        ...
        $('.has-treeview').addClass('menu-closed');
        });
    });
</script>
